...
export default function OccupationPageClient({
  ...
  return (
    <>
      {/* ─── HERO ─── */}
      <section
        style={{ backgroundImage: `linear-gradient(rgba(22,75,63,0.9), rgba(22,75,63,0.9)), url('${getOccupationHeroImage(occ.category)}')`, backgroundSize: "cover", backgroundPosition: "center" }}
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-[56px] leading-tight" style={serif}>
              Lön som {occ.titleGenitive} — SCB 2025
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10 pt-6">
              ...
              <div>
                ...
                {agreementSlug && (
                  <Link href={`/avtal/${agreementSlug}`} className="inline-flex items-center gap-1 text-[15px] font-semibold text-primary hover:underline">
                    Se relaterat avtal <ArrowRight size={14} />
                  </Link>
                )}
            ...
            <div className="space-y-6 lg:sticky lg:top-[80px] lg:self-start">
              ...
              <div className="rounded-sm border border-border bg-card p-6">
                <p className="font-semibold text-text-primary text-[16px] mb-4">SCB 2025</p>
                {[
                  { label: "10:e percentilen", value: occ.salary.minimum, highlight: false },
              ...
              <div className="rounded-sm border border-border bg-card p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="font-semibold text-text-primary text-[16px]">Fråga AI-guiden</p>
                </div>
                <AgreementChat
              ...
              {relatedOccupations.length > 0 && (
                <div className="rounded-sm border border-border bg-card p-6">
                  ...
                  <Link href="/yrke" className="inline-flex items-center gap-1 text-sm font-medium text-primary mt-3 hover:underline">
                    Se alla källgranskade yrken <ArrowRight size={14} />
                  </Link>
                </div>
              )}
      ...
      <section className="pb-12">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl bg-amber-50 border border-amber-200 p-4 text-xs text-amber-900 leading-relaxed">
            Lönerna kommer från SCB:s lönestrukturstatistik 2025 för hela ekonomin, samtliga
            sektorer och totalt för kvinnor och män. Individuell lön beror på bland annat
            erfarenhet, arbetsgivare och ort. Källa: SCB.
          </div>
        </div>
      </section>
    </>
