  ...
  return (
    <>
      ...
      <section className="bg-primary text-white py-10 sm:py-14">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            ...
            <h1 className="text-xl sm:text-3xl font-extrabold leading-tight">{post.title}</h1>
          ...
          {post.content.map((section, i) => (
            <AnimatedSection key={i} delay={i * 0.05}>
              <div className="mb-8 sm:mb-10">
                <h2 className="text-lg sm:text-xl font-bold text-text-primary mb-3">{section.heading}</h2>
                {section.text.split("\n\n").map((paragraph, j) => (
      ...
      <section className="py-8 sm:py-12 bg-white">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <h2 className="text-lg sm:text-xl font-bold text-text-primary mb-6">Vanliga frågor</h2>
          </AnimatedSection>
