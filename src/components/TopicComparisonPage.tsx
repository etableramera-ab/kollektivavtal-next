...
export default function TopicComparisonPage({ title, subtitle, aeoAnswer, columns, rows, ctaText, ctaHref, disclaimer }: Props) {
  return (
    <>
      <section style={{ background: "linear-gradient(135deg, #0F766E 0%, #0A5F59 40%, #0D6B64 100%)" }} className="text-white pt-24 pb-10 sm:pt-28 sm:pb-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            <h1 className="text-4xl sm:text-5xl md:text-[56px]" style={{ fontFamily: "var(--font-dm-serif, var(--font-serif))" }}>{title}</h1>
