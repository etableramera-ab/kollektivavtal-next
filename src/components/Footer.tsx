        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/80">
              ...
              <li>
                <span>Drivs av Etablera Mera AB</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/80">
              <li>
                <Link href="/kollektivavtal/handelsavtalet" className="hover:text-white transition-colors">
                  Handelsavtalet
                </Link>
              </li>
              <li>
                <Link href="/kollektivavtal/teknikavtalet" className="hover:text-white transition-colors">
                  Teknikavtalet
                </Link>
              </li>
              <li>
                <Link href="/kollektivavtal/byggavtalet" className="hover:text-white transition-colors">
                  Byggavtalet
                </Link>
              </li>
              <li>
                <Link href="/kollektivavtal/hok-kommunal" className="hover:text-white transition-colors">
                  HÖK Kommunal
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/80">
              <li>
                <Link href="/hitta-ditt-avtal" className="hover:text-white transition-colors">
                  Hitta ditt avtal
                </Link>
              </li>
              <li>
                <Link href="/lonekalkylator" className="hover:text-white transition-colors">
                  Lönekalkylator
                </Link>
              </li>
              <li>
